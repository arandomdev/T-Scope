...
module tTest_divVal_ap_uint_47_ap_ufixed_16_8_5_3_0_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [46:0] p_read;
input  [39:0] p_read1;
output  [39:0] numDataB_c_din;
input  [2:0] numDataB_c_num_data_valid;
input  [2:0] numDataB_c_fifo_cap;
input   numDataB_c_full_n;
output   numDataB_c_write;
...
reg    numDataB_c_blk_n;
reg    ap_block_state1;
wire   [0:0] icmp_ln23_fu_69_p2;
reg   [0:0] icmp_ln23_reg_118;
wire    ap_CS_fsm_state2;
wire   [15:0] shl_ln_fu_87_p3;
reg   [15:0] ap_phi_mux_meanB_c_0_phi_fu_62_p4;
reg   [15:0] meanB_c_0_reg_58;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state52)) begin
                        ap_return_0_preg[15 : 8] <= ap_phi_mux_meanB_c_0_phi_fu_62_p4[15 : 8];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state52)) begin
                        ap_return_1_preg[15 : 8] <= ap_phi_mux_meanB_c_0_phi_fu_62_p4[15 : 8];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
                meanB_c_0_reg_58[8] <= 1'b0;
        meanB_c_0_reg_58[9] <= 1'b0;
        meanB_c_0_reg_58[10] <= 1'b0;
        meanB_c_0_reg_58[11] <= 1'b0;
        meanB_c_0_reg_58[12] <= 1'b0;
        meanB_c_0_reg_58[13] <= 1'b0;
        meanB_c_0_reg_58[14] <= 1'b0;
        meanB_c_0_reg_58[15] <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state52) & (icmp_ln23_reg_118 == 1'd0))) begin
                        meanB_c_0_reg_58[15 : 8] <= shl_ln_fu_87_p3[15 : 8];
        end
    end
end
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        numDataB_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        numDataB_c_write = 1'b1;
    end else begin
        numDataB_c_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((numDataB_c_full_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
always @ (posedge ap_clk) begin
    meanB_c_0_reg_58[7:0] <= 8'b00000000;
    ap_return_0_preg[7:0] <= 8'b00000000;
    ap_return_1_preg[7:0] <= 8'b00000000;
end

endmodule //tTest_divVal_ap_uint_47_ap_ufixed_16_8_5_3_0_s
