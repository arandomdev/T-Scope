...
module tTest_Block_entry2347_proc6_Pipeline_VITIS_LOOP_35_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [31:0] zext_ln35;
output  [7:0] famA_address0;
output   famA_ce0;
input  [31:0] famA_q0;
output  [62:0] tmpSum_out;
output   tmpSum_out_ap_vld;

reg ap_idle;
reg famA_ce0;
reg tmpSum_out_ap_vld;
...
reg   [23:0] lshr_ln_reg_274;
reg   [31:0] famA_load_reg_279;
reg   [53:0] tmp_9_reg_294;
wire   [31:0] zext_ln37_fu_141_p1;
wire    ap_block_pp0_stage0;
reg   [62:0] tmpSum_fu_70;
wire   [62:0] tmpSum_2_fu_230_p2;
wire    ap_loop_init;
reg   [8:0] i_fu_74;
...
wire   [31:0] shl_ln1_fu_146_p3;
wire   [32:0] zext_ln37_1_fu_154_p1;
wire   [32:0] zext_ln35_cast_fu_108_p1;
...
#0 lshr_ln_reg_274 = 24'd0;
#0 famA_load_reg_279 = 32'd0;
#0 tmp_9_reg_294 = 54'd0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        lshr_ln_reg_274 <= 24'd0;
    end else begin
        if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            lshr_ln_reg_274 <= {{mul_ln38_fu_182_p2[31:8]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b0 == ap_block_pp0_stage0_11001)) begin
            tmp_9_reg_294 <= {{grp_fu_104_p2[55:2]}};
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln35_reg_260_pp0_iter2_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmpSum_out_ap_vld = 1'b1;
    end else begin
        tmpSum_out_ap_vld = 1'b0;
    end
end
...
assign add_ln35_fu_131_p2 = (ap_sig_allocacmp_i_6 + 9'd1);

assign and_ln_fu_219_p3 = {{tmp_9_reg_294}, {2'd0}};
...
assign famA_address0 = zext_ln37_fu_141_p1;

assign grp_fu_104_p0 = grp_fu_104_p00;

assign grp_fu_104_p00 = famA_load_reg_279;

assign grp_fu_104_p1 = grp_fu_104_p10;

assign grp_fu_104_p10 = lshr_ln_reg_274;

assign icmp_ln35_fu_125_p2 = ((ap_sig_allocacmp_i_6 == 9'd256) ? 1'b1 : 1'b0);
...
assign shl_ln1_fu_146_p3 = {{trunc_ln37_fu_137_p1}, {24'd0}};

assign sub_ln37_fu_158_p2 = (zext_ln37_1_fu_154_p1 - zext_ln35_cast_fu_108_p1);

assign tmpSum_2_fu_230_p2 = (zext_ln39_fu_226_p1 + tmpSum_fu_70);

assign tmpSum_out = tmpSum_fu_70;

assign trunc_ln37_fu_137_p1 = ap_sig_allocacmp_i_6[7:0];

assign zext_ln35_cast_fu_108_p1 = zext_ln35;

assign zext_ln37_1_fu_154_p1 = shl_ln1_fu_146_p3;

assign zext_ln37_fu_141_p1 = trunc_ln37_fu_137_p1;

assign zext_ln39_fu_226_p1 = and_ln_fu_219_p3;

endmodule //tTest_Block_entry2347_proc6_Pipeline_VITIS_LOOP_35_1
