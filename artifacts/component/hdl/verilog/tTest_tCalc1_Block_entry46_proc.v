...
module tTest_tCalc1_Block_entry46_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
tTest_udiv_23ns_40ns_18_27_seq_1 #(
    ...
    .din1_WIDTH( 40 ),
    .dout_WIDTH( 18 ))
udiv_23ns_40ns_18_27_seq_1_U72(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state29)) begin
                        tCalc1ResultB_preg[31 : 14] <= shl_ln_fu_62_p3[31 : 14];
        end
    end
end
...
always @ (*) begin
    ap_block_state1 = ((numDataB_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
always @ (posedge ap_clk) begin
    tCalc1ResultB_preg[13:0] <= 14'b00000000000000;
end

endmodule //tTest_tCalc1_Block_entry46_proc
