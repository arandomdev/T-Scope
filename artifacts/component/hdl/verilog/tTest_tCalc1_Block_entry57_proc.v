...
module tTest_tCalc1_Block_entry57_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [2:0] numDataB_num_data_valid;
input  [2:0] numDataB_fifo_cap;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 53'd1;
#0 numDataB_read_reg_85 = 40'd0;
#0 mul_ln51_reg_90 = 46'd0;
#0 udiv_ln51_reg_100 = 26'd0;
#0 tCalc1ResultB_preg = 32'd0;
end
...
tTest_udiv_46ns_40ns_26_50_seq_1 #(
    ...
    .din1_WIDTH( 40 ),
    .dout_WIDTH( 26 ))
udiv_46ns_40ns_26_50_seq_1_U67(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((numDataB_empty_n == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
                tCalc1ResultB_preg[6] <= 1'b0;
        tCalc1ResultB_preg[7] <= 1'b0;
        tCalc1ResultB_preg[8] <= 1'b0;
        tCalc1ResultB_preg[9] <= 1'b0;
        tCalc1ResultB_preg[10] <= 1'b0;
        tCalc1ResultB_preg[11] <= 1'b0;
        tCalc1ResultB_preg[12] <= 1'b0;
        tCalc1ResultB_preg[13] <= 1'b0;
        tCalc1ResultB_preg[14] <= 1'b0;
        tCalc1ResultB_preg[15] <= 1'b0;
        tCalc1ResultB_preg[16] <= 1'b0;
        tCalc1ResultB_preg[17] <= 1'b0;
        tCalc1ResultB_preg[18] <= 1'b0;
        tCalc1ResultB_preg[19] <= 1'b0;
        tCalc1ResultB_preg[20] <= 1'b0;
        tCalc1ResultB_preg[21] <= 1'b0;
        tCalc1ResultB_preg[22] <= 1'b0;
        tCalc1ResultB_preg[23] <= 1'b0;
        tCalc1ResultB_preg[24] <= 1'b0;
        tCalc1ResultB_preg[25] <= 1'b0;
        tCalc1ResultB_preg[26] <= 1'b0;
        tCalc1ResultB_preg[27] <= 1'b0;
        tCalc1ResultB_preg[28] <= 1'b0;
        tCalc1ResultB_preg[29] <= 1'b0;
        tCalc1ResultB_preg[30] <= 1'b0;
        tCalc1ResultB_preg[31] <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state53)) begin
                        tCalc1ResultB_preg[31 : 6] <= shl_ln_fu_71_p3[31 : 6];
        end
    end
end
...
always @ (*) begin
    if ((numDataB_empty_n == 1'b0)) begin
...
assign grp_fu_63_p10 = numDataB_read_reg_85;
...
always @ (posedge ap_clk) begin
    tCalc1ResultB_preg[5:0] <= 6'b000000;
end

endmodule //tTest_tCalc1_Block_entry57_proc
