...
entity tTest_divVal_ap_uint_47_ap_ufixed_16_8_5_3_0_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of tTest_divVal_ap_uint_47_ap_ufixed_16_8_5_3_0_1 is 
...
attribute shreg_extract : string;
    ...
    signal ap_phi_mux_meanA_c_0_phi_fu_62_p4 : STD_LOGIC_VECTOR (15 downto 0);
    signal meanA_c_0_reg_58 : STD_LOGIC_VECTOR (15 downto 0) := "0000000000000000";
...
begin
    udiv_47ns_40ns_8_51_seq_1_U24 : component tTest_udiv_47ns_40ns_8_51_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 51,
        din0_WIDTH => 47,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state52)) then 
                                        ap_return_0_preg(15 downto 8) <= ap_phi_mux_meanA_c_0_phi_fu_62_p4(15 downto 8);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state52)) then 
                                        ap_return_1_preg(15 downto 8) <= ap_phi_mux_meanA_c_0_phi_fu_62_p4(15 downto 8);
                end if; 
            end if;
        end if;
    end process;
    ...
    meanA_c_0_reg_58_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                meanA_c_0_reg_58(8) <= '0';
                meanA_c_0_reg_58(9) <= '0';
                meanA_c_0_reg_58(10) <= '0';
                meanA_c_0_reg_58(11) <= '0';
                meanA_c_0_reg_58(12) <= '0';
                meanA_c_0_reg_58(13) <= '0';
                meanA_c_0_reg_58(14) <= '0';
                meanA_c_0_reg_58(15) <= '0';
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state52) and (icmp_ln23_reg_118 = ap_const_lv1_0))) then 
                                        meanA_c_0_reg_58(15 downto 8) <= shl_ln_fu_87_p3(15 downto 8);
                end if; 
            end if;
        end if;
    end process;

    meanA_c_0_reg_58(7 downto 0) <= "00000000";
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, numDataA_c_full_n)
    begin
                ap_block_state1 <= ((numDataA_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_meanA_c_0_phi_fu_62_p4_assign_proc : process(icmp_ln23_reg_118, shl_ln_fu_87_p3, meanA_c_0_reg_58, ap_CS_fsm_state52)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state52) and (icmp_ln23_reg_118 = ap_const_lv1_0))) then 
    ...
    ap_return_0_assign_proc : process(ap_phi_mux_meanA_c_0_phi_fu_62_p4, ap_CS_fsm_state52, ap_return_0_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state52)) then 
    ...
    ap_return_1_assign_proc : process(ap_phi_mux_meanA_c_0_phi_fu_62_p4, ap_CS_fsm_state52, ap_return_1_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state52)) then 
