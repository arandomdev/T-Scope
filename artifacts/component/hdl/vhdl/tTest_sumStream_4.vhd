...
architecture behav of tTest_sumStream_4 is 
...
attribute shreg_extract : string;
    ...
    signal i_3_reg_211 : STD_LOGIC_VECTOR (7 downto 0) := "00000000";
    ...
    signal i_4_fu_129_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                i_3_reg_211 <= ap_const_lv8_0;
            else
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    i_3_reg_211 <= ap_sig_allocacmp_i_3;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sig_allocacmp_i_3_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_fu_64, ap_start_int)
    begin
    ...
    grp_fu_93_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_3_reg_211),40));
    i_4_fu_129_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv8_1));
    ...
    zext_ln13_fu_124_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_3),32));
end behav;
