...
entity tTest_tCalc1_2_Block_entry46_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of tTest_tCalc1_2_Block_entry46_proc is 
...
attribute shreg_extract : string;
    ...
    signal numDataA_read_reg_76 : STD_LOGIC_VECTOR (39 downto 0) := "0000000000000000000000000000000000000000";
...
begin
    udiv_23ns_40ns_18_27_seq_1_U53 : component tTest_udiv_23ns_40ns_18_27_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 27,
        din0_WIDTH => 23,
    ...
    numDataA_read_reg_76_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                numDataA_read_reg_76 <= ap_const_lv40_0;
            else
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state29)) then 
                                        tCalc1ResultA_preg(31 downto 14) <= shl_ln_fu_62_p3(31 downto 14);
                end if; 
            end if;
        end if;
    end process;
    ...
    tCalc1ResultA_preg(13 downto 0) <= "00000000000000";
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, numDataA_empty_n)
    begin
                ap_block_state1 <= ((numDataA_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0));
    end process;
    ...
    tCalc1ResultA_assign_proc : process(shl_ln_fu_62_p3, tCalc1ResultA_preg, ap_CS_fsm_state29)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state29)) then 
