...
attribute shreg_extract : string;
    ...
    signal numDataA_read_reg_82 : STD_LOGIC_VECTOR (39 downto 0) := "0000000000000000000000000000000000000000";
...
begin
    udiv_63ns_40ns_23_67_seq_1_U45 : component tTest_udiv_63ns_40ns_23_67_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 67,
        din0_WIDTH => 63,
    ...
    numDataA_read_reg_82_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                numDataA_read_reg_82 <= ap_const_lv40_0;
            else
    ...
    begin
                ap_block_state1 <= ((numDataA_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (numDataA_c_full_n = ap_const_logic_0));
    end process;
    ...
    grp_fu_71_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(numDataA_read_reg_82),63));
    icmp_ln23_fu_63_p2 <= "1" when (numDataA_read_reg_82 = ap_const_lv40_0) else "0";
