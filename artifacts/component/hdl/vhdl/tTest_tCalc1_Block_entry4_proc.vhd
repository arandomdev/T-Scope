...
entity tTest_tCalc1_Block_entry4_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of tTest_tCalc1_Block_entry4_proc is 
...
begin
    ...
    add_ln50_fu_40_p2 <= std_logic_vector(unsigned(numDataB_dout) + unsigned(ap_const_lv40_FFFFFFFFFF));
    ...
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (numDataB_c_full_n = ap_const_logic_0) or (numDataB_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
